                    ...
                    <div className="col-span-8">
                        ...
                        variants={slideLeft}
                          ...
                          >
                            ...
                            <div>
                                <p className="leading-relaxed text-black/75 mb-6">
                                    ...
                                    We remain committed to empowering the next generation of professionals, embracing innovation, and continuing to support the UAE’s growth and prosperity.
                                </p>
                    ...
                    <div className="col-span-8">
                        <motion.div
                            ...
                            <div>
                                ...
                                <p className="leading-relaxed text-black/75">As a local UAE company, our foundations are deeply rooted in the values of this country. We don’t just construct buildings; we build trust, create opportunity, and contribute to shaping the future of our communities.</p>
<p className="leading-relaxed text-black/75">Every project we undertake reflects our dedication to precision, safety, and innovation. With a passionate team and a forward-looking vision, we remain committed to continuing our legacy and reinforcing our role as a key partner in the UAE’s development.

Together, we build the future — with purpose, pride, and excellence.</p>
