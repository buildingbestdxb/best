                ...
                <div className='grid grid-cols-3 gap-5'>
                    ...
                    <div className='col-span-1'>
                        ...
                        <ImageUploader value={watch("image")} onChange={(url) => setValue("image", url)} />
                            <p className='text-xs text-gray-500'>{generateDimentions("home", "about_main")}</p>
                            <Label>Alt Tag</Label>
                                ...
                                <DialogContent>
                                    <DialogHeader>
                                        ...
                                        <DialogDescription>
                                            ...
                                            <p className='text-xs text-gray-500'>{generateDimentions("home", "about_seals")}</p>
                                        </DialogDescription>
                                    </DialogHeader>
                                            ...
                                            <DialogHeader>
                                                ...
                                                <DialogDescription>
                                                    <div className='flex flex-col gap-2'>
                                                        ...
                                                        <p className='text-xs text-gray-500'>{generateDimentions("home", "about_card_logo")}</p>
                                                        <Label>Alt Tag</Label>
