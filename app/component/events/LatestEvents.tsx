...
const latestNews = data && data.data.filter((item)=>item.type=="event").sort((a, b) => new Date(b.date).getTime() - new Date(a.date).getTime())
const prevNewsData = data && data.data.filter((item)=>item.type=="event").sort((a, b) => new Date(b.date).getTime() - new Date(a.date).getTime())
