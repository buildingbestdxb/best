          ...
          <div className="col-span-8">
            <motion.div className="flex flex-col  gap-[20px] lg:gap-[60px] leading-none" variants={slideRight}>
              ...
              <p className="leading-relaxed text-black/75">
                Since 1975, Building Co. (BEST) L.L.C has been shaping the UAE’s construction landscape with a commitment
                to excellence, innovation, and reliability. Specializing in large-scale residential, commercial,
                and governmental projects, we have successfully delivered luxury villas, hospitals, and high-profile
                buildings that stand as benchmarks of quality. With decades of expertise, a client-centric approach,
                and a dedication to superior craftsmanship, we continue to build lasting landmarks that redefine industry standards.
              </p>
