...
const AdminSectors = () => {
        ...
        const [sectors, setSectors] = useState<{bannerImage:string,name:string;image:string;icon:string,_id:string}[]>([])
...
const handleSetEditRegion = async(bannerImage:string,name:string,image:string,icon:string) =>{
    setOldName(name)
    ...
    <div className='flex flex-col gap-5'>
        ...
        <div className='p-2 h-screen overflow-y-scroll flex flex-col gap-5'>
            {sectors && sectors.map((item)=>(
                ...
                <div>
                    <Dialog>
                        <DialogTrigger onClick={()=>handleSetEditRegion(item.bannerImage,item.name,item.image,item.icon)}>Edit</DialogTrigger>
                        <DialogContent>
                            <DialogHeader>
